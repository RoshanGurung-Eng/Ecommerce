...
SECRET_KEY = 'django-insecure-(t2lvu3k8vp@%2*1*_lt6t*t4+kl7929*2_hkvyf24_wuaa-j4'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "HamroPasal",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "HamroPasal",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "HamroPasal",
    ...
    "welcome_sign": "Welcome to the HamroPasal",

    # Copyright on the footer
    "copyright": "HamroPasal Ltd",
